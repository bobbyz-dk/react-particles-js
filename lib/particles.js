...
var Particles =
/*#__PURE__*/
function (_react_1$PureComponen) {
  ...
  function Particles(props) {
    ...
    _this = _possibleConstructorReturn(this, (Particles.__proto__ || Object.getPrototypeOf(Particles)).call(this, props));
    _this.state = {
      canvas: undefined,
      library: undefined
    };
    _this.loadCanvas = _this.loadCanvas.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(Particles, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        style: lib_1.deepExtend(deepClone(this.props.style), {
          width: width,
          height: height
        })
      }));
    ...
    value: function draw() {
      ...
      if (this.color.rgb) {
        var _color$rgb = this.color.rgb,
            ...
            g = _color$rgb.g,
            b = _color$rgb.b;
        color_value = "rgba( ".concat(r, ", ").concat(g, ", ").concat(b, ", ").concat(opacity, " )");
      } else {
        var _color$hsl = this.color.hsl,
            h = _color$hsl.h,
            s = _color$hsl.s,
            l = _color$hsl.l;
        color_value = "hsla( ".concat(h, ", ").concat(s, ", ").concat(l, ", ").concat(opacity, " )");
      }
    ...
    value: function createSvgImg(particle) {
      ...
      var coloredSvgXml = svgXml.replace(rgbHex, function (m, r, g, b) {
        ...
        if (particle.color.rgb) {
          ...
          color_value = "rgba( ".concat(_r, ", ").concat(_g, ", ").concat(_b, ", ").concat(particle.opacity, " )");
        } else {
          var _particle$color$hsl = particle.color.hsl,
              h = _particle$color$hsl.h,
              s = _particle$color$hsl.s,
              l = _particle$color$hsl.l;
          color_value = "rgba( ".concat(h, ", ").concat(s, ", ").concat(l, ", ").concat(particle.opacity, " )");
        }
